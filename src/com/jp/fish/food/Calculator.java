    ...
    public void onCreate(Bundle savedInstanceState)
	{
        ...
        {			
			public void onClick(View v) 
			{
				...
				try
				{
					Class ourClass = Class.forName("com.jp.fish.food.Confirm");
        ...
        {						
			public void onClick(View v) 
			{
				...
				try
				{
					Class ourClass = Class.forName("com.jp.fish.food.Edit_Screen");
					Intent ourIntent = new Intent(Calculator.this, ourClass);
        ...
        {			
			...
			{	    	
				try
				{
					Class ourClass = Class.forName("com.jp.fish.food.Main_Menu");
					Intent ourIntent = new Intent(Calculator.this, ourClass);
